...
Matrix *create_matrix(size_t rows, size_t cols, enum TYPE_NAME type_name)
{
    ...
    if (type_name == ALIGNED) {
        ...
        // aligned_alloc 要求 size 是对齐值的整数倍
...
//         return -1;
//     }
//     long long time_MIN = LLONG_MAX, tp = 0;
...
int check_single(enum TYPE_NAME type)
{
    ...
    printf("512,%lld\n", r512);
    sleep(1);
    long long r1024 = test_outer(1024, 1, 1, type);
    printf("1024,%lld\n", r1024);
    sleep(1);
    long long r2048 = test_outer(2048, 1, 1, type);
    printf("2048,%lld\n", r2048);
    sleep(1);
    long long r4096 = test_outer(4096, 1, 1, type);
    printf("4096,%lld\n", r4096);
    sleep(1);
    long long r8192 = test_outer(8192, 1, 1, type);
    printf("8192,%lld\n", r8192);
    return 0;
}
...
int main()
{
    ...
    // Matrix *A=create_matrix(8192,8192,IMPROVED3);
    // Matrix *B=create_matrix(8192,8192,IMPROVED3);
    // Matrix *C=create_matrix(8192,8192,IMPROVED3);
    // randomize_matrix(A);
    // randomize_matrix(B);
    // matmul_improved3(8192, A, B, C);
    // matmul_improved3(8192, A, B, C);
    // matmul_improved3(8192, A, B, C);
    // matmul_improved3(8192, A, B, C);
    // matmul_improved3(8192, A, B, C);
    ...
    long long r4096 = test_outer(4096, 1, 1, IMPROVED3);
    printf("4096,%lld\n", r4096);
    return 0;
}